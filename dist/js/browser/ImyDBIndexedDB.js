...
},{"./lib/ImyDBBase.js":2,"./lib/util.js":9,"./param/ERROR.js":10,"./param/ImyDBSLI2.param.js":11,"sli2":16}],2:[function(require,module,exports){
/* ImyDBBase.js */
...
},{"./analyzeFragments.js":4,"./calculateScore.js":7,"./stringToFragments.js":8}],3:[function(require,module,exports){
(function(cxt, global) {
  "use strict";
...
},{"./calcFragmentNum.js":6}],8:[function(require,module,exports){
...
},{"./arrayAddSuffix.js":5}],9:[function(require,module,exports){
/* util.js */
...
},{"../lib/SyncPromise.js":3,"../lib/util.js":9}],12:[function(require,module,exports){
(function (global){
/*!
...
},{"./lib/DatabaseDefinition.js":17,"./lib/Ddl.js":18,"./lib/Dml.js":19,"./lib/Table.js":24,"./lib/Tasker.js":25,"./lib/idbInit.js":29,"./param/Error.js":31}],17:[function(require,module,exports){
/* DatabaseDefinition */
...
},{"../param/Error.js":31}],18:[function(require,module,exports){
/* Ddl.js */
...
},{"../param/Error.js":31,"./Querable.js":20,"./Table.js":24}],19:[function(require,module,exports){
/* Dml.js */
...
},{"../param/Error.js":31,"./Querable.js":20,"./SelectionAggregator.js":22,"./SyncPromise.js":23,"./arraySortWithObjectElement.js":26,"./arrayUniqueMerge.js":27,"./asyncLoop.js":28,"./setFunction.js":30,"Kriteria":32,"clone":37}],20:[function(require,module,exports){
/* Querable.js */
...
},{"../param/Error.js":31}],21:[function(require,module,exports){
/* SLI2Operator.js */
...
},{"../param/Error.js":31,"./setFunction.js":30}],22:[function(require,module,exports){
...
},{"../param/Error.js":31,"./SLI2Operator.js":21,"criteria2IDBQuery":38}],25:[function(require,module,exports){
/* Tasker.js */
(function(cxt) {
  "use strict";
...
},{"./SyncPromise.js":23}],29:[function(require,module,exports){
/* idbInit.js */
...
},{"./lib/Condition.js":33,"./lib/evaluation.js":34,"./lib/getProperty.js":35,"./lib/matchPrefix.js":36}],33:[function(require,module,exports){
/* Condition.js */
...
},{"./Condition.js":33}],35:[function(require,module,exports){
/* getProperty.js */
...
},{"./lib/analyzeConditionsFromCriteria.js":41,"./lib/createIndicesFromObjectStore.js":42,"./lib/createQueryParameterFromConditionsAndIndices.js":43}],39:[function(require,module,exports){
...
},{"./Query.js":40,"kriteria":44}],42:[function(require,module,exports){
...
},{"./IndexAggregator.js":39,"kriteria":44}],44:[function(require,module,exports){
...
},{"./lib/Condition.js":45,"./lib/evaluation.js":46,"./lib/getProperty.js":47}],45:[function(require,module,exports){
!function(e){"use strict";var t=function(e,t,i,r,h){this.left_key=e,this.operator=t,this.right_key=i,this.key_type=r,this.criteria=h};t.prototype.clone=function(){return new t(this.left_key,this.operator,this.right_key.concat(),this.key_type,this.criteria)},t.prototype.not=function(){switch(this.operator){case"eq":this.operator="ne";break;case"ne":this.operator="eq";break;case"lt":this.operator="ge";break;case"le":this.operator="gt";break;case"gt":this.operator="le";break;case"ge":this.operator="lt";break;case"in":this.operator="not_in";break;case"not_in":this.operator="in";break;case"between":this.operator="not_between";break;case"not_between":this.operator="between";break;case"match":this.operator="not_match";break;case"not_match":this.operator="match"}return this},t.prototype.normalize=function(){var e=[],i=0,r=0;if("value"===this.key_type)switch(this.operator){case"in":for(i=0,r=this.right_key.length;r>i;i+=1)e[e.length]=new t(this.left_key,"eq",[this.right_key[i]],this.key_type,null);break;case"not_in":for(i=0,r=this.right_key.length;r>i;i+=1)e[e.length]=new t(this.left_key,"ne",[this.right_key[i]],this.key_type,null);break;case"between":e[e.length]=new t(this.left_key,"ge",[this.right_key[0]],this.key_type,null),e[e.length]=new t(this.left_key,"le",[this.right_key[1]],this.key_type,null);break;case"not_between":e[e.length]=new t(this.left_key,"lt",[this.right_key[0]],this.key_type,null),e[e.length]=new t(this.left_key,"gt",[this.right_key[1]],this.key_type,null);break;default:e[e.length]=this.clone()}else e[e.length]=this.clone();return e},e.Condition=t}(this);
...
},{"./Condition.js":45}],47:[function(require,module,exports){
